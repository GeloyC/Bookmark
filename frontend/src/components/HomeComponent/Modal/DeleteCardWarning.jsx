    ...
    return (
        <div className="modal-in flex flex-col items-start w-[600px] h-auto bg-[#191919] p-[2rem] pb-[2.5rem] rounded-[15px] border border-[#FAFAFA]/15 gap-[1rem]">
            <div className="flex items-center w-full">
                <span className="text-[#FAFAFA] text-[24px] font-bold">Do you want to delete "{card.title}" card?</span>
            </div>

            <div className='flex items-center w-full gap-2'>
                <button onClick={()=>handleDeleteLink.mutate({id:card.id})} className='bg-[#B90000]/75 hover:bg-[#B90000] active:bg-[#B90000]/75 py-3 rounded-[10px] w-full cursor-pointer'>
