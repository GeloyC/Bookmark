...
export const CreateLinkButton = ({
    ...
    return (
        <button onClick={()=>setCreateLinkModalOpen(true)} className='flex items-center bg-[#71cb47] hover:bg-[#71cb47]/80 active:bg-[#71cb47]/25 p-2 rounded-[10px] cursor-pointer'>
